...
function App() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("http://localhost:3000/api/participant/register", regData)
      .then((res) => {
        ...
        >
          <form className="full-form" onSubmit={handleSubmit}>
            ...
            <div className="inputdiv">
              <label htmlFor="teamName" id="teamName">
                TEAM NAME
              </label>
              <input
                type="text"
            ...
            <div className="inputdiv">
              <label htmlFor="m1Name" id="m1Name">
                MEMBER1 NAME
              </label>
              <input
                type="text"
            ...
            <div className="inputdiv">
              <label htmlFor="m1Email" id="m1Email">
                MEMBER1 EMAIL
              </label>
              <input
                type="mail"
            ...
            <div className="inputdiv">
              <label htmlFor="m1PhoneNumber" id="m1PhoneNumber">
            ...
            <div className="inputdiv">
              <label htmlFor="m2Name" id="m2Name">
                MEMBER2 NAME
              </label>
              <input
                type="text"
            ...
            <div className="inputdiv">
              <label htmlFor="m2PhoneNumber" id="m2PhoneNumber">
            ...
            <div className="inputdiv">
              <label htmlFor="m3Name" id="m3Name">
                MEMBER3 NAME
              </label>
              <input
                type="text"
            ...
            <div className="inputdiv">
              <label htmlFor="m3PhoneNumber" id="m3PhoneNumber">
            ...
            <div className="inputdiv">
              <label htmlFor="m4Name" id="m4Name">
                MEMBER4 NAME
              </label>
              <input
                type="text"
            ...
            <div className="inputdiv">
              <label htmlFor="m4PhoneNumber" id="m4PhoneNumber">
                MEMBER4 PHONE NUMBER
              </label>
              <input
                type="tel"
                name="m4PhoneNumber"
                className="inputbox"
                value={formData.m4PhoneNumber}
                onChange={handleChange}
                required
              />
            </div>
            ...
            {/* <div className="inputdiv">
              <label htmlFor="transection_id" id="transection_id">
                KIT:
              </label>
              <br />
              <label>
            ...
            <div className="inputdiv">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Enter transection_id if paid"
                required
              />
            </div>
            <div className="inputdiv">
